public class Main {
	...
	public static void main(String[] args) {
		...
		// Değişken isimlendirmeleri java'da camelCase yazılır.(ilk kelimenin harfi küçük 2. kelime büyük.)
		// Javada yazılanlar daima ; ile bitmeli.
		...
		int vade = 12; // int tam sayılar için kullanılır.
		
		double dolarDun = 18.25; // doble ondalıklı sayılar için kullanılır.
